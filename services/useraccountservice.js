...
const UserAccountDAO = require('../datamodel/useraccount/useraccountdao')
const Useraccountservice = require('../datamodel/useraccount/useraccount')
...
module.exports = class UserAccountService {
    ...
    insert(displayname, login, password) {
        return this.dao.insert(new Useraccountservice(displayname, login, this.hashPassword(password)))
    }
